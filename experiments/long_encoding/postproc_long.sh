...
do 
    ...
    tail -n 155 "$f" | head -n 153 >> log.GA.lhs.36.log
done

for f in EA.lhs.36*
do 
    tail -n 1 "$f" >> summary.EA.lhs.36.log
    tail -n 155 "$f" | head -n 153 >> log.EA.lhs.36.log
done

for f in GA.lhs.108*
do 
    tail -n 1 "$f" >> summary.GA.lhs.108.log
    tail -n 155 "$f" | head -n 153 >> log.GA.lhs.108.log
done

for f in EA.lhs.108*
do 
    tail -n 1 "$f" >> summary.EA.lhs.108.log
    tail -n 155 "$f" | head -n 153 >> log.EA.lhs.108.log
done
...
do 
    ...
    tail -n 155 "$f" | head -n 153 >> log.GA.rand.36.log
done

for f in EA.rand.36*
do 
    tail -n 1 "$f" >> summary.EA.rand.36.log
    tail -n 155 "$f" | head -n 153 >> log.EA.rand.36.log
done

for f in GA.rand.108*
do 
    tail -n 1 "$f" >> summary.GA.rand.108.log
    tail -n 155 "$f" | head -n 153 >> log.GA.rand.108.log
done

for f in EA.rand.108*
do 
    tail -n 1 "$f" >> summary.EA.rand.108.log
    tail -n 155 "$f" | head -n 153 >> log.EA.rand.108.log
done
...
do 
    ...
    tail -n 155 "$f" | head -n 153 >> log.GA.centroids.36.log
done

for f in EA.centroids.36*
do 
    tail -n 1 "$f" >> summary.EA.centroids.36.log
    tail -n 155 "$f" | head -n 153 >> log.EA.centroids.36.log
done

for f in GA.centroids.108*
do 
    tail -n 1 "$f" >> summary.GA.centroids.108.log
    tail -n 155 "$f" | head -n 153 >> log.GA.centroids.108.log
done

for f in EA.centroids.108*
do 
    tail -n 1 "$f" >> summary.EA.centroids.108.log
    tail -n 155 "$f" | head -n 153 >> log.EA.centroids.108.log
done
